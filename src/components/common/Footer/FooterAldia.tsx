    ...
    <footer className={classes.footer}>
      <Container size={"xl"} className={classes.inner}>
        <div className={classes.logo}>
          ...
          <Text size="xs" color="dimmed" className={classes.description}>
            ALDIA Group is an International Engineering Consultancy based in
            London. We deliver advanced solutions fully focused on Mechanical,
            Electronic-Electrical / Embedded Systems, Project Management,
      ...
      <Container className={classes.afterFooter} size={"xl"}>
        <Text color="dimmed" size="sm">
          © 2015-2022 Aldia Consultech SL | All rights reserved |{" "}
          <Link href="/terms-and-condition">Legal Notice</Link>
        </Text>
